...
function reducer(state, action) {
    switch(action.type){
        ...
        case "ADD_TO_CART":
            {
                ...
                if (existing) {
                    return {
                        ...state,
                        cart: state.cart.map((i)=>i.sku === action.item.sku && i.size === action.item.size ? {
                                ...i,
        ...
        case "REMOVE_FROM_CART":
            return {
                ...state,
                cart: state.cart.filter((i)=>i.sku !== action.sku)
            };
        case "CLEAR_CART":
            return {
                ...state,
        ...
        case "SET_DEMO_MODE":
            return {
                ...state,
                demoMode: action.active,
                demoStep: action.active ? 0 : state.demoStep
            };
        case "SET_DEMO_STEP":
            return {
                ...state,
...
_s(StoreProvider, "GUSXxL/WUElrtHc/X73NyHNRMdw=");
_c = StoreProvider;
function useStore() {
    _s1();
...
//# sourceMappingURL=_432154ed._.js.map