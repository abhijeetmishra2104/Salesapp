...
var __TURBOPACK__imported__module__$5b$project$5d2f$mock$2f$customers$2e$json__$28$json$29$__ = __turbopack_context__.i("[project]/mock/customers.json (json)");
;
;
const tierDiscounts = {
    bronze: 0.05,
...
const activePromotions = [
    {
        code: "WEDDING20",
        discount: 0.2,
        description: "20% off wedding collection",
        validCategories: [
            "heels",
            "flats"
        ]
    ...
    },
    {
        code: "LOYALTY2X",
        discount: 0,
        description: "Double loyalty points this week",
        pointsMultiplier: 2
    }
];
async function POST(request) {
    ...
    const customer = __TURBOPACK__imported__module__$5b$project$5d2f$mock$2f$customers$2e$json__$28$json$29$__["default"].find((c)=>c.id === customerId);
    if (!customer) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__74215609._.js.map