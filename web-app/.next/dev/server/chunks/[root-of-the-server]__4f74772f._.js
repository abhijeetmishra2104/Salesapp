...
"[project]/app/api/mock/inventory/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const stores = __TURBOPACK__imported__module__$5b$project$5d2f$mock$2f$inventory$2e$json__$28$json$29$__["default"].stores;
    const inventory = JSON.parse(JSON.stringify(__TURBOPACK__imported__module__$5b$project$5d2f$mock$2f$inventory$2e$json__$28$json$29$__["default"].inventory));
    ...
    if (sku) {
        ...
        if (skuInventory) {
            const storesWithStock = stores.filter((store)=>(skuInventory[store.id] || 0) > 0).map((store)=>({
                    ...store,
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ...
                data: {
                    ...
                    totalStoreStock: Object.entries(skuInventory).filter(([key])=>key !== "online").reduce((sum, [, qty])=>sum + qty, 0)
                }
            });
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4f74772f._.js.map